...
const letterPatterns: { [key: string]: number[] } = {
  ...
  " ": [],
  ".": [300, 301, 302, 303, 304],
  "@": [1, 2, 3, 4, 50, 100, 151, 152, 153, 200, 204, 250, 300, 301, 302, 303, 304, 54],
  "#": [1, 102, 202, 3, 104, 204, 151, 152, 153, 50, 150, 250, 54, 154, 254],
};
...
export function CommitsGrid({ text, className, onAnimationComplete }: CommitsGridProps) {
  ...
  const getRandomColor = () => {
    ...
    return commitColors[Math.floor(Math.random() * commitColors.length)];
  };
  ...
  // Signal animation complete after the max animation delay + duration
  React.useEffect(() => {
